...
class TestFAISSVectorStore:
    ...
    def test_create_from_documents(self, mock_faiss_class, temp_dir, mock_embeddings, sample_documents):
        ...
        mock_faiss_class.from_documents.assert_called_once_with(sample_documents, mock_embeddings)
    ...
    def test_get_retriever_no_vector_store_raises_error(self, temp_dir, mock_embeddings):
...
class TestPineconeVectorStore:
    ...
    def test_pinecone_store_initialization(self, mock_pinecone_class, mock_embeddings, pinecone_config):
        ...
        store = PineconeVectorStoreWrapper("test-index", mock_embeddings, pinecone_config)
    ...
    def test_create_from_documents(self, mock_pinecone_vector_store, mock_pinecone_class, 
                                   mock_embeddings, pinecone_config, sample_documents):
    ...
    @patch('vector_stores.pinecone_store.PINECONE_AVAILABLE', True)
    @patch('vector_stores.pinecone_store.Pinecone')
    def test_delete_success(self, mock_pinecone_class, mock_embeddings, pinecone_config):
...
class TestVectorStoreFactory:
    ...
    def test_create_pinecone_store(self, mock_embeddings_class, mock_embeddings):
        ...
        with patch('vector_stores.factory.PineconeVectorStoreWrapper') as mock_pinecone_class:
            mock_pinecone_instance = Mock()
            mock_pinecone_class.return_value = mock_pinecone_instance
